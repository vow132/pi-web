...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "customUpdate.upToDate": "已是最新（v{version}）— 定制版",
    "customUpdate.available": "上游 v{version} 可用 — 点击自动更新（保留定制功能）",
    "customUpdate.updating": "更新中：正在合并上游、重新构建、重启服务…",
    "customUpdate.checkFailed": "无法检查更新",
    "customUpdate.confirm": "现在自动更新吗？\n\n将合并上游主分支到定制版，重新构建并重启服务，需要几分钟。",
    "files.newFile": "新建文件",
