...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "customUpdate.upToDate": "已是最新（v{version}）— 定製版",
    "customUpdate.available": "上游 v{version} 可用 — 點擊自動更新（保留定製功能）",
    "customUpdate.updating": "更新中：正在合併上游、重新建置、重啟服務…",
    "customUpdate.checkFailed": "無法檢查更新",
    "customUpdate.confirm": "現在自動更新嗎？\n\n將合併上游主分支到定製版，重新建置並重啟服務，需要幾分鐘。",
    "files.newFile": "新增檔案",
