...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "customUpdate.upToDate": "Up to date (v{version}) — customized build",
    "customUpdate.available": "Upstream v{version} available — click to auto-update (customizations preserved)",
    "customUpdate.updating": "Updating: merging upstream, rebuilding, restarting…",
    "customUpdate.checkFailed": "Update check unavailable",
    "customUpdate.confirm": "Auto-update now?\n\nThis merges upstream main into the customized build, rebuilds and restarts the service. It takes a few minutes.",
